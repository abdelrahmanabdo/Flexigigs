    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <form id="sendmessage" onreset="$('.message-modal').modal('hide');$" method="post" action="{{route('sendmessage')}}">
                ...
                <input type="hidden" name="id_from" value="0">
                ...
                <div class="modal-body">
                    <div class="form-group addmsg">
                        ...
                        <textarea name="msg" maxlength="2500" class="form-control counted send-msg" rows="1" placeholder="Message"></textarea>
    ...
    $(document).ready(function() { 
        $('#sendmessage').ajaxForm( {
            ...
            success: function (message) {
                ...
                $.post('{{route("admin_mymessages",[$userdata->id])}}',
                { page: 0,
                  limit:10,
                  type:"admin",
