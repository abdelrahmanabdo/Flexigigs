    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title text-capitalize">@lang('service_category.dashboard_supplier_add_service')</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                <form  onreset="$('.add-service').modal('hide');" method="post" id="add-service" action="{{ route('add_service') }}">
                    <div class="container">
                        {{ csrf_field() }}      
                        <div class="row">
                            <div class="col-12">
                                <label class="form-group has-float-label addname mb-0">
                                    <input type="text" name="name" autocomplete="off" maxlength="200" class="form-control counted" placeholder="@lang('service_category.dashboard_supplier_service_name')" required>
                                    <span>@lang('service_category.dashboard_supplier_service_name')</span>
                                    <p class="char mb-0">0/200</p>
                                    <p class="help-block d-none mt-5"> <strong></strong> </p>
                                </label>
                                <div class="mx-0 my-5">
                                    
                                    <div class="form-group mb-0" id="parent">
                                        <label class="text-hide" for="gig">@lang('service_category.dashboard_supplier_select_category')</label>
                                        <select class="form-control" id="parentselector"  autocomplete="off" name="parent" required>
                                    ...
                                    <p class="help-block addcategory"></p>
                                    <p class="h6">@lang('service_category.no_cat') <a href="{{route('contact-us')}}" class="text-primary">@lang('service_category.no_cat_contact_us')</a></p>
                                </div>             
                                <div class="ml-0 mb-5">
                                    <label class="form-group d-flex justify-content-between addprice has-float-label mt-5">
                                        <input type="number" name="price_per_unit" min="0" class="form-control counted" placeholder="@lang('service_category.dashboard_supplier_add_price')" required>
                                        <span>@lang('service_category.dashboard_supplier_add_price')</span>
                                    ...
                                    <label class="form-group d-flex justify-content-between addunit has-float-label mt-5" required>
                                        <select class="form-control mt-3" name="price_unit" required>
                                            <option disabled value="" selected>@lang('service_category.dashboard_admin_price_unit')</option>
                                            <option value="hour">@lang('service_category.dashboard_supplier_price_hours')</option>
                                            <option value="project">@lang('service_category.dashboard_supplier_price_project')</option>
                                        </select>
                                    ...
                                    <script>
                                        ...
                                        (function(){
                                            ...
                                            $priceUnitSelection.change(function(){
                                                if($(this).val() === 'hour'){
                                                    $daysContainer.html('<input type="number" name="days_to_deliver" min="0" class="form-control" placeholder="@lang("service_category.dashboard_supplier_select_type_days")" required> <span>@lang("service_category.dashboard_supplier_select_type_hours")</span> ');
                                                } else if ($(this).val() === 'project'){
                                                    $daysContainer.html('<input type="number" name="days_to_deliver" min="0" class="form-control" placeholder="@lang("service_category.dashboard_supplier_select_type_days")" required> <span>@lang("service_category.dashboard_supplier_select_type_days")</span> ');
                                                } else {
                                                    $daysContainer.html('');
                                                }                                            
                                            });
                                    ...
                                    <label class="form-group adddescription has-float-label mt-5" required>
                                        <textarea name="description" rows="1" class="form-control counted" placeholder="@lang('service_category.dashboard_supplier_description')"></textarea>
                                        <span>@lang("service_category.dashboard_supplier_description")</span>
                                        <p class="char">0/2500</p>
                                        <p class="help-block d-none" style="margin-top: 70px;"> <strong></strong> </p>
                                    </label>
                                </div>
                            </div>
                            <div class="col-12">
                                <label class="form-group has-float-label addterms">
                                    <textarea name="terms" class="form-control counted" maxlenght="2500" placeholder="@lang('service_category.dashboard_supplier_terms_conditions')" rows="1" required></textarea>
                                ...
                                <label class="form-group has-float-label mb-0 addquestion1" style="margin-top:5rem;">
                                    <input name="question1" class="form-control" placeholder="@lang('service_category.dashboard_supplier_requirements')*" type="text" maxlength="200" required>
                                    <span>@lang("service_category.dashboard_supplier_requirements")*</span>
                                    <p class="help-block d-none"> <strong></strong> </p>
                                    <small><a href="#" class="first-add" onclick="$(this).addClass('d-none');$('.question2').removeClass('d-none');" title="">@lang('service_category.dashboard_supplier_add_question')</a></small>                                        
                                </label>

                                <label class="form-group question2 has-float-label d-none mt-5 mb-0">
                                    <input type="text" name="question2" class="form-control" placeholder="@lang('service_category.dashboard_supplier_requirements')" maxlength="200">
                                    <span>@lang('service_category.dashboard_supplier_requirements')</span>
                                    <small><a href="#" class="secound-add" onclick="$(this).addClass('d-none');$('.question3').removeClass('d-none');" title="">@lang('service_category.dashboard_supplier_add_question')</a></small>
                                ...
                                <label for="" class="form-group question3 has-float-label d-none mt-5 mb-0">
                                    <input type="text" name="question3" class="form-control" placeholder="@lang('service_category.dashboard_supplier_requirements')" maxlength="200">
                                    <span>@lang('service_category.dashboard_supplier_requirements')</span>
                                ...
                                <div class="form-group mt-5">
                                    <div id="add-s-img">
                                        <label class="mb-0">@lang('service_category.dashboard_supplier_portfolio')</label>
                                        <label class="custom-file">
                                            <input type="file" name="img[]" required class="custom-file-input" accept="image/*" >
                                            <span class="custom-file-control"></span>
                                        </label>
                                    </div>
                                    <small><a href="#" class="mt-0" id="add_moreimg">@lang('service_category.dashboard_supplier_portfolio_add')</a></small>
                                    ...
                                    <label class="has-float-label form-group" id="add-s-video">
                                        <input type="text" name="videourl[]" class="form-control" placeholder="@lang('service_category.dashboard_supplier_video_URL')">
                                        ...
                                        <script>
                                            $(document).ready(function(){
                                                ...
                                                $("#add_morevideo").click(function(){
                                                    ...
                                                    var showId = ++id;
                                                    if(videos.length <= 9){
                                                        $('#add-s-video').append('<lable class="vid-'+showId+' has-float-label mt-3"> <input name="videourl[]" class="form-control" placeholder="Video URL '+showId+'" type="text"><span>@lang("service_category.dashboard_supplier_video_URL") '+showId+'</span><p><a class="text-danger" style="cursor:pointer;position:absolute;top:-25px;right:5px;" onclick="$(\'.vid-'+showId+'\').remove();$(\'#add_morevideo\').removeClass(\'d-none\');showId = --id;console.log(showId)" title="">X</a></p></label>');
                                                        if(videos.length == 9){
                                        ...
                                        <small><a href="#" id="add_morevideo">@lang('service_category.dashboard_supplier_video_URL_add')</a></small>
                                    </label>
                                </div>
    ...
    $(document).ready(function() { 
        $('#add-service').ajaxForm( {
            ...
            success: function (message) {
                swal("@lang('service_category.dashboard_supplier_service_save_title')", "@lang('service_category.dashboard_supplier_service_save_msg')", "success").then(function () {
                    location.reload();
                });
            },
