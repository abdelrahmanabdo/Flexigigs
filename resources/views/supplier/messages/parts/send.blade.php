    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <form id="sendmessage" onreset="$('.message-modal').modal('hide');$" method="post" action="{{route('sendmessage')}}">
                ...
                <input type="hidden" name="conflect" id="conflect" value="0">
                ...
                <div class="modal-body">
                    <div class="form-group addmsg">
                        <label class="text-hide">@lang('messages.messages.message')</label>
                        <textarea name="msg" maxlength="2500" class="form-control counted send-msg" rows="1" placeholder="@lang('messages.messages.message')"></textarea>
