        ...
        <div class="item msgbox">
                    ...
                    <div class="w-100" class="message-head">
                        <div class="w-100">
                            <div class="mt-3 pl-5 position-relative">
                                ...
                                <br>
                                <span class="text-dark message-head-info">{{$message->order->customer->username}} (@lang('general.gigger_name'))</span>
            ...
            <div id="message-{{$message->id}}" class="item-content collapse message-collapse" role="tabpanel">
                <div class="scrollable" data-messageid="{{$message->id}}" data-to="{{Auth::user()->id}}" data-page="0"  data-order_id="{{$message->order_id}}">
                    ...
                    @include('customer.messages.parts.subitem')
                </div>
...
<script type="text/javascript">
    $( document ).ready(function() {
     ...
     function loadmore(messageid,id_from,id_to,limit=5) {
        ...
        $.post('{{route("customer_messagewith")}}',
        { page: page,
          limit:limit,
          id_from:id_from,
          id_to:id_to,
