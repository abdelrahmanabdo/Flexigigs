<div class="reviews">
    <div class="header mb-5">
        <h3 class="review-head">@lang('general.reviews_title')</h3>
        ...
        <div class="review">
            <div class="header">
                <div class="user">
                    ...
                    <div>
                        <p>{{$review->order->supplier->username}}</p>
                        <p>{{($review->order->type == 1)?trans('general.service').' : '.$review->order->request->name:trans('general.gig').' :
                         '.$review->order->application->title}}</p>
                    </div>
                </div>
