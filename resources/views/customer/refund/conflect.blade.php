            ...
            <form id="conflect" onreset="$('.message-modal').modal('hide');$" method="post" action="{{route('sendmessage')}}">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        <label class="text-hide">@lang('general.button_message')</label>
                        <textarea name="msg" maxlength="2500" class="form-control counted send-msg" rows="1" placeholder="@lang('general.button_message')"></textarea>
