...
<style>
    ...
    .login .content{margin:35px auto;} * {font-family: cairo;} h1,h2,h3,h4,h5,h6,p{font-family:cairo !important;}
</style>
    <body class=" login">
        <!-- BEGIN LOGO -->
        <div class="logo">
        ...
        <div class="content">
            <!-- BEGIN LOGIN FORM -->
            <?=form_open('users',['class'=>'login-form','method'=>'POST'])?>    
                ...
                <div class="form-group">
                    ...
                    <div class="input-icon">
                        ...
                        <input class="form-control placeholder-no-fix" type="text" autocomplete="off" placeholder="أسم المستخدم" name="user_name" /> </div>
                </div>
<!--                 <div class="form-group">
 ...
 -->                <div class="form-actions">
                    ...
                    <button type="submit" class="btn green pull-left"> دخول </button>
                </div>
            ...
            <?=form_open('users/forget',['class'=>'forget-form','method'=>'POST'])?>    
                 <h3>نسيت كلمة المرور ؟</h3>
                <p class="text-left"> أدخل رقم هاتفك  </p>
